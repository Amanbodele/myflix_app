...
function Player() {
    ...
    useEffect(() => {
        ...
        fetch("https://api-for-myflixapp.onrender.com/movies/" + params.id, {
            headers: {
    ...
    function play() {
        ...
        fetch("https://api-for-myflixapp.onrender.com/users/play", {
            method: "POST",
            headers: {
    ...
    function closePlayer() {
        let myflix_user = JSON.parse(localStorage.getItem("myflix-user"))
        fetch(`https://api-for-myflixapp.onrender.com/users/closeplayer/${userMovie._id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${myflix_user.token}`
                    ...
                    playerVisible === false ? (
                        ...
                        <div className='vid-player'>
                            ...
                            <video ref={videoPlayer} controls className='movie-player' autoPlay>
                                ...
                                <source src={`https://api-for-myflixapp.onrender.com/movies/stream/${movie._id}`} />
                            </video>
                        </div>
